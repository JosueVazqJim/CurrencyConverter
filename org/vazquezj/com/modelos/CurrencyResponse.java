...
public class CurrencyResponse implements CurrencyConversion {
    ...
    public CurrencyResponse(String result, String time_last_update_utc, String time_next_update_utc, double conversion_rate, double conversion_result) {
        this.result = result;
    ...
    public CurrencyResponse(CambioRecord cambioRecord) {
